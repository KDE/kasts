...
public class KastsService extends Service implements QtSignalListener<Boolean> {
    private static final String TAG = "org.kde.kasts.KastsService";
    private static final String CHANNEL_ID = "background_playback";
    private static final int NOTIFICATION_ID = 0xC4515;
    ...
    private Notification buildNotification()
    {
        ...
        Intent notificationIntent = new Intent(this, KastsActivity.class);
        PendingIntent pendingIntent = PendingIntentCompat.getActivity(this, 0, notificationIntent, 0, false);

        notificationBuilder
                .setVisibility(NotificationCompat.VISIBILITY_PUBLIC)
                .setPriority(NotificationCompat.PRIORITY_DEFAULT)
                .setSmallIcon(R.mipmap.ic_notification_kasts)
                .setContentTitle(!Player.metadata.title.isEmpty() ? Player.metadata.title : "Kasts")
