...
void AndroidPlayerJni::propertyChanged(const QString &property, const QVariant &value)
{
    ...
    QJniObject::callStaticMethod<void>("org/kde/kasts/Player",
                                       "propertyChanged",
...
void AndroidPlayerJni::registerNativeMethods()
{
    ...
    QJniEnvironment env;
    jclass clazz = env.findClass("org/kde/kasts/Player");
