...
FormCard.FormCardPage {
    ...
    FormCard.FormHeader {
        title: KI18n.i18nc("@title Form header for settings related to storage paths", "Storage path")
    ...
    FormCard.FormCard {
        ...
        FormCard.FormTextDelegate {
            id: storagePath
            visible: Qt.platform.os !== "android" // not functional on android
            text: KI18n.i18nc("@label showing path used for local storage", "Storage path")
            description: StorageManager.storagePath

            trailing: Controls.Button {
                Layout.leftMargin: Kirigami.Units.largeSpacing
                icon.name: "document-open-folder"
                text: KI18n.i18nc("@action:button", "Select folder…")
            ...
            StorageDirDialog {
                ...
                title: KI18n.i18nc("@title of dialog box", "Select Storage Path")
            }
        }
    }
    ...
    FormCard.FormHeader {
        Layout.fillWidth: true
        title: KI18n.i18nc("@title Form header for section showing information about local storage", "Information")
    }
    ...
    FormCard.FormCard {
        ...
        FormCard.FormTextDelegate {
            ...
            trailing: Controls.Button {
                ...
                text: KI18n.i18nc("@action:button", "Clear Cache")
